...
d = DataLoader()
test_right_ending_nr, test_context_sentences, test_ending_sentence1, test_ending_sentence2 = d.load_test_data_with_right_ending_nr()
number_of_training_samples = len(test_right_ending_nr)
