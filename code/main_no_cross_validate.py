...
# Takes optional 1 argument of type int:
# random seed to shuffle data, such that the same validation set can be used for different experiments
# if no argument is passed, a random seed is generated
